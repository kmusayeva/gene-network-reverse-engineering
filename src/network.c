 ...
 * partially based on the  algorithm by Barbara Di Camillo, Gianna Toffolo, and Claudio Cobelli. "A gene network simulator to assess reverse engineering algorithms.", 2009.
